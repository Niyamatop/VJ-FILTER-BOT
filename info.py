...
# Bot information
SESSION = environ.get('SESSION', 'Zero_two_filter_bot')
API_ID = int(environ.get('API_ID', '28298365'))
API_HASH = environ.get('API_HASH', '9647ab7fc03a8a93f701a5528b2f206e')
BOT_TOKEN = environ.get('BOT_TOKEN', "6677757538:AAE2AIVRczHbJqbiaPvxyxoVC7u6yB6BhU0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002239117016'))6073523936').split()
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5536168611').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002239117016').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Venom786:Venom786@venom123.xt8sm46.mongodb.net/?retryWrites=true&w=majority&appName=Venom123")
DATABASE_NAME = environ.get('DATABASE_NAME', "Venom123")
